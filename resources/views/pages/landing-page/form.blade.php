        ...
        <div class="container">
            ...
            <form class="row g-3 mt-4" action="{{ route('registration') }}" method="post">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control form-control-lg" name="name" id="name" placeholder="masukan nama lengkap">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control form-control-lg" name="birthday_place" id="birthday-place" placeholder="masukan tempat lahir">
                </div>
                <div class="col-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="school_origin" class="form-control form-control-lg" id="origin" placeholder="masukan asal sekolah">
                </div>
                <div class="col-md-6">
                    <label for="phone" class="form-label">No. Hp/Wa</label>
                    <input type="number" name="phone" class="form-control form-control-lg" id="phone" placeholder="masukan nomor hp/wa">
                </div>
                <div class="mb-3">
