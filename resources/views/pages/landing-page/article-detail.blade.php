...
@section('content')
    ...
    <div class="my-5 article-page">
        <div class="container">
            <div class="card border-0">
                <div class="card-body text-center py-5">
                    <div class="header text-center d-flex justify-content-center">
                        <h2 style="width: 50%" class="text-center">{{ $data->title }}</h2>
                        
                    </div>
                    <div class="content">
                        <span>{{ $data->created_at }}</span>
                        <div class="img mt-4">
                            <img width="60%" src="/storage/image/article/{{ $data->thumbnail }}" alt="">
                        </div>
                        <div class="text mt-5 text-start">
                            {!! $data->content !!}
                        </div>
                    </div>
                </div>
